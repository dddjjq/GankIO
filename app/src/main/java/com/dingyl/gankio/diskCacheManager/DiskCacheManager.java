package com.dingyl.gankio.diskCacheManager;
...
public class DiskCacheManager {
    ...
    public DiskCacheManager(Context context, String uniqueName) {
        try {
            ...
            Log.d(TAG,"cacheFile name is : " + cacheFile.getPath());
